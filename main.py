...
###################################
# Agent 1: Flight Agent (AviationStack MCP)
###################################
FLIGHT_AGENT_PROMPT = """
...
###################################
# Agent 2: Hotel Agent (Tavily MCP)
###################################
...
##########################################
# Agent 3: Weather Agent (OpenWeather MCP)
##########################################
def weather_agent(state: TravelState):
    ...
    return {
        "weather_results": f"""Current Weather:{weather_data} Forecast:{forecast_data}""",
        "messages": [AIMessage(content="Weather information fetched")],
    }


###################################
# Agent 4: Itinerary Agent (LLM)
###################################
